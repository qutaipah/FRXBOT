...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (!args.length)
      return message
        .reply(`***Command: play
أضف أغنية لقائمة الانتظار وتشغيلها.
الأختصارات:
=p
الاستخدام:
=play (اسم الاغنية) - تشغيل النتيجة الاولى في اليوتيوب
=play (URL) - تشغيل الأغنية , قائمة التشغيل , البث بناءًا على الرابط المُرفق
أمثله للأمر:
=play Havana
=play (URL) ***`)
        .catch(console.error);
